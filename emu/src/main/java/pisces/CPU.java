...
public class CPU {
    ...
    // CPU will manipulate the display, input, and window
    ...
    // Address 0x200 is the start of program in memory
    public CPU (byte[] rom_program, int program_length, Display display, Window window, Input input) {
        ...
        this.keypad = this.input.getKeypad();
    ...
    // Fetches the instruction OPCODE at current PC.
